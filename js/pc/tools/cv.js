  ...
  const projects = [
    ...
    },
    {
      ...
      bullets: [
        ...
        'SIEM dashboard: Event Timeline (live feed with 1h/6h/24h/7d filters, auto-refresh every 30s) and Incidents page (auto-detected by 7 correlation rules — brute force, XSS, SQLi, prototype pollution, IOC spike, port scan, credential stuffing). Global view across all users and external sources.',
